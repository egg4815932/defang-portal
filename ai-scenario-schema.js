...
var DFAISchema = (function () {
  ...
  choice('openaiBrain', '大腦模型', '模型與連線', [['gpt-6-luna', 'Luna 6 · 快又便宜（2026/9 新版）'], ['gpt-6-sol', 'Sol 6 · 更聰明、少犯錯'], ['gpt-6-astra', 'Astra · 旗艦推理，語音會變慢'], ['gemini-3.5-flash-lite', 'Gemini 3.5 Flash Lite · 走你的 Google 額度'], ['gemini-3.8-flash', 'Gemini 3.8 Flash · 走你的 Google 額度']], 'gpt-6-luna', '只適用 GPT-Live-1。一通 10 分鐘的大腦費用約 Luna 6 US$0.015、Sol 6 約 US$0.30、Astra US$1.30；語音層另計 US$0.05／分鐘。Astra 沒有「不思考」檔位。選 Gemini 時改由我們自己接大腦：思考程度不適用、字幕必須設為「雙方」，回話也會比 OpenAI 慢一點。');
  ...
  range('nudgeMinutes', '通話到第幾分鐘送出提醒', '模型與連線', 0, 30, 1, 0, '分鐘', '0 表示不提醒。通話計時到這個分鐘數時，把下面那句話送給 AI，整通只送一次。設得比通話時間長就不會觸發。');
  text('nudgeText', '到時間要送出的話', '模型與連線', '', 200, '例如「請客氣地說你趕時間，開始收尾」。通話中才送出，不會寫進開場的系統指令。Gemini 當成你說的一句話送進去；GPT-Live 當成應用指令插入對話，單則上限 500 token，所以這格限 200 字。取消右邊的勾選就不送。');
